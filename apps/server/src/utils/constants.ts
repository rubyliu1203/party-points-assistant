...
export const DIM1_QUARTER_SCORES: Record<number, { leader: number; member: number; other: number }> = {
  1: { leader: 4, member: 3, other: 3 },
  2: { leader: 4, member: 3, other: 3 },
  3: { leader: 4, member: 3, other: 3.5 },
  4: { leader: 4, member: 3, other: 3.8 }
};

export const DIM3_QUARTER_SCORES: Record<number, { shuangYou: number; teamLeader: number; other: number }> = {
